...
{
    [Option('p', "propertytype", Required = true, HelpText = "PropertyType, available options: DesiredProperty, Tags")]
    ...
    [Option('v', "values", Required = true, HelpText = "New Property Name/Value pairs")]
    public string Method { get; set; }      

    [Option('d', "id", Required = true, HelpText = "Device Id")]
